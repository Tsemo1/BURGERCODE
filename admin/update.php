...
$nameError = $descriptionError = $priceError = $imageError = $categoryError = $description = $price = $category = $image = $name = "";
if (!empty($_POST)) {
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" id="category" name="category" class="form-control">
                            ...
                            foreach ($db->query('SELECT * FROM categorie') as $row) {
                                if ($row['id'] == $category) {
                                    echo '<option slected ="selected" value=' . $row['id'] . '>' . $row['name'] . '</option>';
                                } else {
